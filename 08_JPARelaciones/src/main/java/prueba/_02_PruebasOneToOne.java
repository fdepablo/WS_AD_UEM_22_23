...
public class _02_PruebasOneToOne {
	...
	public static void main(String[] args) {
		...
		// Si la relaci�n es bidireccional debemos SIEMPRE cruzar las referencias,
		...
		//Como hemos definido la relaci�n en las dos clases con un CASCADE.ALL,
		//persistiendo el objeto Cliente, se persistir�an los dos. Si NO hubiera
		// un CASCADE.ALL o un CASCADE.PERSIST, esta persistencia fallar�a.
		em.persist(c); 
		
		// El siguiente "persist" fallar�a ya que no hay ningun tipo de
		// CASCADE en la clase DatosBancarios
		//em.persist(c);
		//em.persist(db); //-> se inser�a el cliente SI HUBIERA un cascade en DatosBancarios
		...
		//queremos a�adir a lisa unos datos bancarios
		em.getTransaction().begin();
